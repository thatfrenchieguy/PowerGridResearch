...
\begin{document}
	...
	\begin{itemize}
		...
		\item Results/conclusions -drafted
...
From this, we can see that the minimum spanning tree version of the model runs significantly faster and comes to a similar objective. The difference is from one or two elements being scheduled for an earlier shift.
	...
	This is heuristic rather than, but in the limit where all possible subsets are considered, this is a full solution of the bilayer optimization problem. 
	\subsection{Results}
