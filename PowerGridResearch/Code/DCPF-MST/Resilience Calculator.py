...
#acounting for optimal resilience 
ToHardenNodes = np.random.choice(len(Nodes),1,  replace = False)
ToHardenEdges = np.random.choice(len(Edges),3,  replace = False)
for n in ToHardenNodes:
    Grid.node[n]['working']= True
for e in ToHardenEdges:
    Grid[EdgeTracker[e][1][0]][EdgeTracker[e][1][1]][0]['working']=True
