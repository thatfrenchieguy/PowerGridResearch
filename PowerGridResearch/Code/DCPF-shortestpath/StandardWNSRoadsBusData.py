...
#bus 30 edges
Grid.add_edge(0,1, capacity = int(130), Type = "Power", Sus = float(16.64))
Grid.add_edge(0,2, capacity = int(130), Type = "Power", Sus = float(5.096))
Grid.add_edge(1,3, capacity = int(65), Type = "Power", Sus = float(5.197))
Grid.add_edge(2,3, capacity = int(130), Type = "Power", Sus = float(23.53))
Grid.add_edge(1,4, capacity = int(130), Type = "Power", Sus = float(4.77))
Grid.add_edge(1,5, capacity = int(65), Type = "Power", Sus = float(5.116))
Grid.add_edge(3,5, capacity = int(90), Type = "Power", Sus = float(22.31))
Grid.add_edge(4,6, capacity = int(70), Type = "Power", Sus = float(7.44))
Grid.add_edge(5,6, capacity = int(130), Type = "Power", Sus = float(11.02))
Grid.add_edge(5,7, capacity = int(32), Type = "Power", Sus = float(22.01))
Grid.add_edge(5,8, capacity = int(65), Type = "Power", Sus = float(4.807))
Grid.add_edge(5,9, capacity = int(32), Type = "Power", Sus = float(9.09))
Grid.add_edge(8,9, capacity = int(65), Type = "Power", Sus = float(3.906))
Grid.add_edge(8,10, capacity =int( 65), Type = "Power", Sus =float( 7.14))
Grid.add_edge(3,11, capacity =int( 65), Type = "Power", Sus = float(3.17))
Grid.add_edge(11,12, capacity = int(65), Type = "Power", Sus = float(6.1))
Grid.add_edge(11,13, capacity = int(32), Type = "Power", Sus = float(4.1))
Grid.add_edge(11,14, capacity = int(32), Type = "Power", Sus = float(2.25))
Grid.add_edge(11,15, capacity = int(32), Type = "Power", Sus = float(4.37))
Grid.add_edge(13,14, capacity = int(16), Type = "Power", Sus = float(2.25))
Grid.add_edge(15,16, capacity = int(16), Type = "Power", Sus = float(4.37))
Grid.add_edge(14,17, capacity = int(16), Type = "Power", Sus = float(3.69))
Grid.add_edge(17,18, capacity = int(16), Type = "Power", Sus = float(6.21))
Grid.add_edge(18,19, capacity = int(30), Type = "Power", Sus = float(11.764))
Grid.add_edge(9,19, capacity = int(32), Type = "Power", Sus = float(3.98))
Grid.add_edge(9,16, capacity = int(32), Type = "Power", Sus = float(10.31))
Grid.add_edge(9,20, capacity = int(32), Type = "Power", Sus = float(10.98))
Grid.add_edge(9,22, capacity = int(32), Type = "Power", Sus = float(5.400))
Grid.add_edge(20,21, capacity = int(32), Type = "Power", Sus = float(34.127))
Grid.add_edge(14,22, capacity = int(16), Type = "Power", Sus = float(3.97))
Grid.add_edge(21,23, capacity = int(16), Type = "Power", Sus = float(3.95))
Grid.add_edge(22,23, capacity = int(16), Type = "Power", Sus = float(2.989))
Grid.add_edge(23,24, capacity = int(16), Type = "Power", Sus = float(2.28))
Grid.add_edge(24,25, capacity = int(16), Type = "Power", Sus = float(1.871))
Grid.add_edge(24,26, capacity = int(16), Type = "Power", Sus = float(3.76))
Grid.add_edge(26,27, capacity = int(65), Type = "Power", Sus = float(2.71))
Grid.add_edge(26,28, capacity = int(16), Type = "Power", Sus = float(1.881))
Grid.add_edge(26,29, capacity = int(16), Type = "Power", Sus = float(1.293))
Grid.add_edge(28,29, capacity = int(16), Type = "Power", Sus = float(1.72))
Grid.add_edge(7,27, capacity = int(32), Type = "Power", Sus = float(4.54))
Grid.add_edge(5,27, capacity = int(32), Type = "Power", Sus = float(15.46))
...
for i in range(0,30):
    ...
    for index, row in Connect.iterrows():
        if (int(row['To']) != i) and (Grid.has_edge(i, int(row['To']))==False):
            Grid.add_edge(i, int(row['To']), length = float(row['Distance']), Type = "Road")
#p connections
for i in range(0,30):
    j=i
    while j < 30:
        ...
        if (rand <= NWS_p) and (i!=j) and (Grid.has_edge(i,j)==False):
            Grid.add_edge(i,j, length=float(math.sqrt((Grid.node[i]['xcoord']-Grid.node[j]['xcoord'])**2+(Grid.node[i]['ycoord']-Grid.node[j]['ycoord'])**2)), Type="Road")
        j=j+1
...
nx.draw(H)
nx.write_gml(Grid, "Bus30WithData.graphml")