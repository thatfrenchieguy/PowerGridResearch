...
The IEEE 30 bus network is a standard power grid that approximately resembles the power grid in southern Illinois in the 1960s \$CITE THIS. More importantly, it's been a well understood standard test grid since it's inception.

\includegraphics[natwidth=.5]{Bus30Figure.png}
